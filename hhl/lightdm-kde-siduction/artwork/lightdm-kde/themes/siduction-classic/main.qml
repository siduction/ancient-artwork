...
Item {
    ...
    Connections {
        ...
        onAuthenticationComplete: {
            if(greeter.authenticated) {
                ...
                feedbackLabel.text = i18n("Incorrect password or username!");
    ...
    ParallelAnimation {
		...
		NumberAnimation { target: headerImage; property: "opacity"; to: 0; duration: 400; easing.type: Easing.InOutQuad }
        NumberAnimation { target: welcomeLabel; property: "opacity"; to: 0; duration: 400; easing.type: Easing.InOutQuad }
    }
    
    Image {
		id: headerImage
		source: "img/lightdm-header.png"
            ...
            Row {
                ...
                height: childrenRect.height
					...
					*/
						...
						ToolButton {
							id: loginButton
							iconSource: "go-jump-locationbar" //"go-next"
							onClicked: {
								login();
							}
					...
					FeedbackLabel {
						...
						IconButton { // TODO - figure out, how to get custom ICONs working, iconSource doesn't work
							id: optionsButton
							anchors.right: parent.right;
							anchors.top: welcomeLabel.bottom
							anchors.topMargin: 2
							anchors.rightMargin: 50
							icon: "system-log-out" //"img/system-log-out.png"
							onClicked: {
								optionsMenu.open();
							}
						}    
