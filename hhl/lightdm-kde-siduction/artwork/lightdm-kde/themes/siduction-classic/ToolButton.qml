...
FocusScope {
    ...
    implicitHeight: Math.max(theme.defaultFont.mSize.height*1, Math.max(icon.height, label.paintedHeight) + surface.margins.top/2 + surface.margins.bottom/2)
    ...
    Item {
        ...
        Private.IconLoader {
            ...
            height: 16 //roundToStandardSize(parent.height)
            width: 16 //height
        }
